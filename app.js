...
const defaultState = () => ({
  ...
  triage: { symptom:'', severity:'', redFlags:[], status:'empty', submittedAt:null, actionStatus:'new', disposition:'', handledBy:'', handledAt:null, nurseNote:'', patientFeedback:'' },
  scenario: 'routine',
...
function normalize(raw) {
  ...
  return {
    ...
    triage: { ...d.triage, ...(raw.triage || {}), redFlags: Array.isArray(raw.triage?.redFlags) ? raw.triage.redFlags : d.triage.redFlags },
